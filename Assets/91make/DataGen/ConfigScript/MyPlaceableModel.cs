...
public partial class MyPlaceableModel
{
	...
	public MyPlaceableModel()
	{
		list.Add(new MyPlaceable(){
			...
			associatedPrefab = "MyPlaceables/Archer Red",
			alternatePrefab = "MyPlaceables/Archer Blue",
		...
		list.Add(new MyPlaceable(){
			...
			name = "Mage",
			pType = Placeable.PlaceableType.Unit,
			associatedPrefab = "MyPlaceables/Mage Red",
			alternatePrefab = "MyPlaceables/Mage Blue",
			attackType = ThinkingPlaceable.AttackType.Ranged,
			targetType = Placeable.PlaceableTarget.Both,
			attackRatio = 1.5f,
			damagePerAttack = 3f,
		...
		list.Add(new MyPlaceable(){
			...
			name = "Warrior",
			pType = Placeable.PlaceableType.Unit,
			associatedPrefab = "MyPlaceables/Warrior Red",
			alternatePrefab = "MyPlaceables/Warrior Blue",
