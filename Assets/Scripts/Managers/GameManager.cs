...
namespace UnityRoyale
{
    public class GameManager : MonoBehaviour
    {
        ...
        private CardManager cardManager;//我方出兵
        private CPUOpponent CPUOpponent;//敌方出兵
        private InputManager inputManager;
		private AudioManager audioManager;//音效管理
		private UIManager UIManager;//UI管理器
		private CinematicsManager cinematicsManager;//剧情动画管理器

        private List<ThinkingPlaceable> playerUnits, opponentUnits;//玩家可移动单位，敌方可移动单位
        private List<ThinkingPlaceable> playerBuildings, opponentBuildings;//玩家防御塔，敌方防御塔
        private List<ThinkingPlaceable> allPlayers, allOpponents; //所有玩家游戏单位，所有敌方游戏单位（可移动的+不可移动的）    contains both Buildings and Units  
		private List<ThinkingPlaceable> allThinkingPlaceables;//所有带AI游戏单位
		private List<Projectile> allProjectiles;//所有投掷物
